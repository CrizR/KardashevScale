...
const crispr = 'https://kardashev-calc.s3.amazonaws.com/crispr.mp4';
const atomboy = 'https://kardashev-calc.s3.amazonaws.com/atomboy.mp4';
                ...
                <React.Fragment>
                    ...
                    >
                        ...
                        <div className="component component-9">
                            <video src={crispr} autoPlay={true} muted={true} loop={true} playsInline={true}/>
                            <TypeII/>
                        </div>
                        ...
                        <div className="component component-11">
                            <video src={atomboy} autoPlay={true} muted={true} loop={true} playsInline={true}/>
                            <TypeIV/>
                        </div>
